...
contract Lending is ReentrancyGuard, Ownable , Logs , PriceConsumerV3{
    ...
    uint256 constant public LIQUIDATION_REWARD = 5;
    // 80% Collateral Factor
    uint256 constant public LIQUIDATION_THRESHOLD = 80;
    uint256 constant public MIN_HEALTH_FACTOR = 1e18; 
    // 1% Borrowing Fees
    uint256 constant public BORROWING_FEES=1;
        ...
        isMoreThanZero(amount)
    {
        ...
        s_accountsToTokenBorrows[msg.sender][token]+=amount * (100 + BORROWING_FEES) / 100;
